...
export const generateBaseToml = (customIgnorePaths = []) => {
    ...
    const formattedCustomPaths = customIgnorePaths.map(path => `'''${path}'''`);

    const allPaths = [...defaultIgnores, ...formattedCustomPaths];
